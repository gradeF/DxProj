...
void cLeftArm::Setup()
{
...

	{
		...
		m_vecVertex[2].t.x = (float)48 / 64; m_vecVertex[2].t.y = (float)20 / 32;  //앞면 윗삼각 
		...
		m_vecVertex[5].t.x = (float)48 / 64; m_vecVertex[5].t.y = (float)32 / 32;  //앞면 아랫삼각
		...
		m_vecVertex[8].t.x = (float)56 / 64; m_vecVertex[8].t.y = (float)20 / 32;  //뒷면 윗삼각
		...
		m_vecVertex[11].t.x = (float)52 / 64; m_vecVertex[11].t.y = (float)20 / 32;  //뒷면 아랫삼각
		...
		m_vecVertex[14].t.x = (float)44 / 64; m_vecVertex[14].t.y = (float)20 / 32;  //왼쪽면 윗삼각
		...
		m_vecVertex[17].t.x = (float)44 / 64; m_vecVertex[17].t.y = (float)32 / 32;  //왼쪽면 아랫삼각
		...
		m_vecVertex[20].t.x = (float)52 / 64; m_vecVertex[20].t.y = (float)20 / 32;  //오른면 윗삼각
		...
		m_vecVertex[23].t.x = (float)52 / 64; m_vecVertex[23].t.y = (float)32 / 32;  //오른면 아랫삼각
		...
		m_vecVertex[26].t.x = (float)48 / 64; m_vecVertex[26].t.y = (float)16 / 32;  //윗면 윗삼각
		...
		m_vecVertex[29].t.x = (float)48 / 64; m_vecVertex[29].t.y = (float)20 / 32;  //윗면 아랫삼각
		...
		m_vecVertex[32].t.x = (float)52 / 64; m_vecVertex[32].t.y = (float)20 / 32;  //아랫면 윗삼각
		...
		m_vecVertex[35].t.x = (float)52 / 64; m_vecVertex[35].t.y = (float)16 / 32;  //아랫면 아랫삼각
